...
const en: LocaleType = {
  ...
  Auth: {
    ...
    Confirm: "Sign In",
    WalletLogin: "Wallet Identity",
    PasskeyLogin: "Sign In with Passkey",
    WalletTitle: "Wallet Identity",
    PasskeyTitle: "Passkey Sign In",
    WalletDescription: "Authorize your identity with a wallet extension",
    PasskeyDescription: "Authorize your identity with a local passkey",
    WalletHint:
      "Your wallet extension will ask you to confirm the authorization.",
    PasskeyHint: "Continue the passkey verification in Router.",
    PasskeyPreparing: "Preparing your passkey QR code...",
    PasskeyRefresh: "Refresh QR Code",
    PasskeyOpen: "Can't scan? Use this device's passkey",
    SwitchToWalletLogin: "Switch to wallet identity sign-in",
    SwitchToPasskeyLogin: "Switch to passkey sign-in",
    WalletUnavailable:
      "No wallet extension was detected. Choose passkey sign-in instead.",
    Later: "Later",

...
const cn = {
  ...
  Auth: {
    ...
    WalletTitle: "钱包身份登录",
    PasskeyTitle: "通行证登录",
    WalletDescription: "通过钱包扩展完成身份授权",
    PasskeyDescription: "使用本地通行证完成身份授权",
    WalletHint: "将唤起钱包扩展以确认身份授权。",
    PasskeyHint: "将在 Router 中继续完成通行证验证。",
    PasskeyPreparing: "正在生成通行证二维码...",
    PasskeyRefresh: "重新生成二维码",
    PasskeyOpen: "无法扫码？使用本机通行证登录",
    SwitchToWalletLogin: "切换到钱包身份登录",
    SwitchToPasskeyLogin: "切换到通行证登录",
    WalletUnavailable: "未检测到可用的钱包扩展，请选择通行证登录",
    Later: "稍后再说",
    Processing: "处理中...",
    EmptyHistory: "暂无历史地址",
